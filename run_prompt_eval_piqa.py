...
def run_command_with_gpu(prompt, gpu_id):
    ...
    command = [
        ...
        'python3 run.py '
        f'--datasets piqa_gen_1194eb-{gpu_id} '
        '--hf-type base '
        '--hf-path /home/chenxing/Meta-Llama-3-8B '
        '--peft-path /home/chenxing/model/piqa_sft_ZOPO_prompt ',
        '--num-gpus 1 '
        '--debug'
    ]
    try:
...
def run_prompt_part(gpu_id, prompt_part, ws):
    ...
    file_path = f"/home/chenxing/opencompass/configs/datasets/piqa/piqa_gen_1194eb-{gpu_id}.py"
...
if __name__ == "__main__":
    prompt_path = "/home/chenxing/opencompass/prompt/robust_testdataset_piqa.xlsx"
    save_path = "/home/chenxing/opencompass/prompt/robust_testdataset_piqa_sft_ZOPO_prompt_result_time.xlsx"
    # 给每个GPU分一块
    wb = Workbook()
    ws = wb.active
