...
def _create_flexora_optimizer(
    ...
    logger.info(
        f"Using Flexora optimizer with layer-wise update, switch mode is {finetuning_args.badam_switch_mode}, "
    )
...
def create_custom_optimzer(
    ...
    if finetuning_args.use_flexora:
        return _create_flexora_optimizer(model, training_args, finetuning_args)
