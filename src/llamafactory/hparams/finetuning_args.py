...
class FinetuningArguments(FreezeArguments, LoraArguments, RLHFArguments, GaloreArguments, BAdamArgument):
    ...
    use_flexora: bool = field(
        default=False,
        metadata={"help": "Whether or not to use the Flexora optimizer."},
    )
    use_robust_tuning: bool = field(
        default=False,
        metadata={"help": "Whether to use robust tuning"},
    )
    prompt_search_space: str = field(
        default=None,
        metadata={"help": "path to prompt search space"},
    )
